...
//    LOGGER.v("Timecost to load the image: " + (endTimeForLoadImage - startTimeForLoadImage));
        ...
        Log.d("array", inputImageBuffer.getBuffer().array().length + Arrays.toString(inputImageBuffer.getBuffer().array()));
        try {
            Log.d("arrayfloat", inputImageBuffer.getTensorBuffer().getFloatArray().length + Arrays.toString(inputImageBuffer.getTensorBuffer().getFloatArray()));
...
//    LOGGER.v("Timecost to run model inference: " + (endTimeForReference - startTimeForReference));
    ...
    private static List<Recognition> getTopKProbability(Map<String, Float> labelProb) {
        Log.d("labelProb", labelProb.toString());
